  ...
  <div class="container">
    ...
    <div class="lin-wrap">
      <el-form label-width="220px">
        <el-form-item label="当前配图" v-if="social.imageUrl">
        ...
        <el-form-item label="配图上传">
          <input class="fileUploaderClass" type='file' name="uploadBtn" ref="uploadBtn" @change="upLoadFile(social.id)"/>
        </el-form-item>
      </el-form>
    </div>
  </div>
  ...
  export default {
    ...
    methods:{
      ...
      sendFileUpload(id,upLoadFileList) {
        ...
        formData.append('fileType', 'social');
